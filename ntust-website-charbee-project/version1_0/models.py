...
class Shop(m.Model):
    ShopId = m.TextField(primary_key=True, default='', max_length=1, null=False)
...
class Category(m.Model):
    CategoryId = m.TextField(primary_key=True, default='', max_length=2, null=False)
...
class Beverage(m.Model):
    BeverageId = m.TextField(primary_key=True, default='NNN', max_length=3, null=False)
    Shop = m.ForeignKey(Shop, default='X', on_delete=m.CASCADE)
    Category = m.ForeignKey(Category, default='CX', on_delete=m.SET_DEFAULT)
    name = m.TextField(default='', null=False)
    info = m.TextField(null=True,default = 'none')
    imagePath = m.TextField(null=True,default = 'none')
    hasCool = m.BooleanField(null=False, default=True)
...
class BeverageSize(m.Model):
    Number = m.IntegerField(primary_key=True, default=0, null=False)
    BeverageId = m.ForeignKey(Beverage, default='XXX', null=False, on_delete=m.CASCADE)
    size = m.TextField(default='M', max_length=2, null=False)
...
class TeamMember(m.Model):
    StudentId = m.TextField(primary_key = True,default = 'B00000000',max_length = 9,null = False)
